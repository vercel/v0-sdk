...
export function v0Tools(config: V0ToolsConfig = {}): V0ToolsFlat {
  ...
  return {
    ...
    chatsGetPreview: tool({
      description:
        "Get Preview: Returns a short-lived bootstrap URL for opening a chat's live preview in a browser. If the preview isn't ready, the response is null. Poll this endpoint until the response is non-null.",
